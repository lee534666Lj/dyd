...
import com.neu.dyd.utils.ZipCompress;
...
public class TestJavaNio {
    ...
    public static String pathname = "d://temp//read.txt";
    public static String filename = "d://temp//write.txt";
    ...
    public static void writeNIO() {
        ...
        try {
            ...
            ByteBuffer src = Charset.forName("utf8").encode("换行" + "\n" + "换行测试");
